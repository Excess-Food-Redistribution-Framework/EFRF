...
function ProductCards({ params, isPagination, isFilter }: ProductCardsProps) {
        ...
        <Modal.Body>
          <Form>
            ...
            >
              ...
              <Dropdown.Item onClick={() => handleSortChange('distanceAsc')}>
                Distance ▲
              </Dropdown.Item>
              <Dropdown.Item onClick={() => handleSortChange('distanceDesc')}>
                Distance ▼
              </Dropdown.Item>
            </DropdownButton>
          </Form>
