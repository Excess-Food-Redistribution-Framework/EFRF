...
function ProductCards({ page, pageSize, organizationId, notBlocked, notExpired }: ProductCardsProps) {
  
  const { listOfProducts, errorMessage } = GetListOfProducts(page, pageSize, organizationId, notBlocked, notExpired);
  ...
  // Проверим, загружаются ли данные
